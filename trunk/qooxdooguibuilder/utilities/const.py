...
SIGNAL_INIT_DRAG = "Start_Drag" #INDICAÇÃO QUE IRÁ SER INICIADO UM DRAG SOBRE UM CONTROLO
...
#DEFINIÇÃO DO TAMANHO DO PASSO DA ALTERAÇÃO DE TAMANHO (width e height) DOS CONTROLOS
STEP_RESIZE = 5
