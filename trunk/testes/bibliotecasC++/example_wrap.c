...
extern "C" {
#endif
SWIGINTERN int My_variable_set(PyObject *_val) {
  {
    double val;
...
SWIGINTERN PyObject *My_variable_get(void) {
  PyObject *pyobj = 0;
...
SWIGEXPORT void SWIG_init(void) {
  ...
  SWIG_addvarlink(SWIG_globals(),(char*)"My_variable",My_variable_get, My_variable_set);
}
